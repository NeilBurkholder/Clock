...
import com.ncautomation.clock.adapters.ViewPagerAdapter
import com.ncautomation.clock.databinding.ActivityMainBinding
...
class MainActivity : SimpleActivity() {
    ...
    private fun setupTabs() {
        ...
        val tabDrawables = arrayOf(
            com.ncautomation.commons.R.drawable.ic_clock_vector,
            R.drawable.ic_alarm_vector,
            R.drawable.ic_stopwatch_vector,
            R.drawable.ic_hourglass_vector
        )
        val tabLabels = arrayOf(R.string.clock, com.ncautomation.commons.R.string.alarm, R.string.stopwatch, R.string.timer)
    ...
    private fun getSelectedTabDrawableIds() = arrayOf(
        com.ncautomation.commons.R.drawable.ic_clock_filled_vector,

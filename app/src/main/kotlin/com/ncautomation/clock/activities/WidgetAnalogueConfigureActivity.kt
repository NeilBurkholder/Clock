...
import com.ncautomation.clock.databinding.WidgetConfigAnalogueBinding
import com.ncautomation.clock.extensions.config
import com.ncautomation.clock.helpers.MyAnalogueTimeWidgetProvider
...
class WidgetAnalogueConfigureActivity : SimpleActivity() {
    ...
    private fun initVariables() {
        ...
        if (mBgColor == resources.getColor(com.ncautomation.commons.R.color.default_widget_bg_color) && config.isUsingSystemTheme) {
            mBgColor = resources.getColor(com.ncautomation.commons.R.color.you_primary_color, theme)
        }

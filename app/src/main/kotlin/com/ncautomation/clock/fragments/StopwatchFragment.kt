...
import com.ncautomation.clock.adapters.StopwatchAdapter
import com.ncautomation.clock.databinding.FragmentStopwatchBinding
import com.ncautomation.clock.extensions.config
import com.ncautomation.clock.extensions.formatStopwatchTime
import com.ncautomation.clock.helpers.SORT_BY_LAP
import com.ncautomation.clock.helpers.SORT_BY_LAP_TIME
import com.ncautomation.clock.helpers.SORT_BY_TOTAL_TIME
import com.ncautomation.clock.helpers.Stopwatch
import com.ncautomation.clock.models.Lap
...
class StopwatchFragment : Fragment() {
    ...
    private fun updateIcons(state: Stopwatch.State) {
        val drawableId =
            if (state == Stopwatch.State.RUNNING) com.ncautomation.commons.R.drawable.ic_pause_vector else com.ncautomation.commons.R.drawable.ic_play_vector
        ...
        (activity as SimpleActivity).handleNotificationPermission { granted ->
            if (granted) {
                ...
                PermissionRequiredDialog(
                    ...
                    com.ncautomation.commons.R.string.allow_notifications_reminders,

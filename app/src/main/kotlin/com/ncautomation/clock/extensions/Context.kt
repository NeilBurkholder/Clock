...
import com.ncautomation.clock.activities.ReminderActivity
import com.ncautomation.clock.activities.SnoozeReminderActivity
import com.ncautomation.clock.activities.SplashActivity
import com.ncautomation.clock.databases.AppDatabase
import com.ncautomation.clock.helpers.*
import com.ncautomation.clock.interfaces.TimerDao
...
import com.ncautomation.clock.receivers.*
import com.ncautomation.clock.services.SnoozeService
...
fun Context.getFormattedDate(calendar: Calendar): String {
    ...
    val dayString = resources.getStringArray(com.ncautomation.commons.R.array.week_days_short)[dayOfWeek]
    val monthString = resources.getStringArray(com.ncautomation.commons.R.array.months)[month]
...
fun Context.showRemainingTimeMessage(totalMinutes: Int) {
    val fullString = String.format(getString(com.ncautomation.commons.R.string.time_remaining), formatMinutesToTimeString(totalMinutes))
...
fun Context.formatTo12HourFormat(showSeconds: Boolean, hours: Int, minutes: Int, seconds: Int): String {
    val appendable = getString(if (hours >= 12) com.ncautomation.commons.R.string.p_m else com.ncautomation.commons.R.string.a_m)
...
fun Context.getClosestEnabledAlarmString(callback: (result: String) -> Unit) {
    getEnabledAlarms { enabledAlarms ->
        ...
        val dayOfWeek = resources.getStringArray(com.ncautomation.commons.R.array.week_days_short)[dayOfWeekIndex]
...
fun Context.getTimerNotification(timer: Timer, pendingIntent: PendingIntent, addDeleteIntent: Boolean): Notification {
    ...
    val builder = NotificationCompat.Builder(this)
        ...
        .addAction(
            ...
            getString(com.ncautomation.commons.R.string.dismiss),
            if (addDeleteIntent) {
...
fun Context.getAlarmNotification(pendingIntent: PendingIntent, alarm: Alarm): Notification {
    ...
    val label = alarm.label.ifEmpty {
        getString(com.ncautomation.commons.R.string.alarm)
    }
    ...
    val builder = NotificationCompat.Builder(this)
        ...
        .addAction(com.ncautomation.commons.R.drawable.ic_cross_vector, getString(com.ncautomation.commons.R.string.dismiss), dismissIntent)
...
fun Context.getAlarmSelectedDaysString(bitMask: Int): String {
    return when (bitMask) {
        TODAY_BIT -> getString(com.ncautomation.commons.R.string.today)
        TOMORROW_BIT -> getString(com.ncautomation.commons.R.string.tomorrow)
        EVERY_DAY_BIT -> getString(com.ncautomation.commons.R.string.every_day)

...
import com.ncautomation.clock.databinding.DialogEditAlarmBinding
import com.ncautomation.clock.extensions.*
import com.ncautomation.clock.helpers.PICK_AUDIO_FILE_INTENT_ID
...
class EditAlarmDialog(val activity: SimpleActivity, val alarm: Alarm, val onDismiss: () -> Unit = {}, val callback: (alarmId: Int) -> Unit) {
    ...
    init {
        ...
        binding.apply {
            ...
            val dayLetters = activity.resources.getStringArray(com.ncautomation.commons.R.array.week_day_letters).toList() as ArrayList<String>
    ...
    private fun checkDaylessAlarm() {
        if (alarm.days <= 0) {
            val textId = if (alarm.timeInMinutes > getCurrentDayMinutes()) {
                com.ncautomation.commons.R.string.today
            } else {
                com.ncautomation.commons.R.string.tomorrow
            }

...
import com.ncautomation.clock.databinding.ItemTimerBinding
...
import com.ncautomation.clock.extensions.secondsToMillis
    ...
    private fun setupView(view: View, timer: Timer) {
        ItemTimerBinding.bind(view).apply {
            ...
            val drawableId = if (state is TimerState.Running) {
                com.ncautomation.commons.R.drawable.ic_pause_vector
            } else {
                com.ncautomation.commons.R.drawable.ic_play_vector
            }

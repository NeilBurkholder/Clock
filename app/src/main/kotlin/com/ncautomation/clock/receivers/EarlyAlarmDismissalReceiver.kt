...
import com.ncautomation.clock.extensions.getClosestEnabledAlarmString
import com.ncautomation.clock.extensions.getDismissAlarmPendingIntent
import com.ncautomation.clock.extensions.getOpenAlarmTabIntent
import com.ncautomation.clock.helpers.ALARM_ID
import com.ncautomation.clock.helpers.EARLY_ALARM_DISMISSAL_CHANNEL_ID
import com.ncautomation.clock.helpers.EARLY_ALARM_NOTIF_ID
    ...
    private fun triggerEarlyDismissalNotification(context: Context, alarmId: Int) {
        context.getClosestEnabledAlarmString { alarmString ->
            ...
            val notification = NotificationCompat.Builder(context)
                ...
                .addAction(0, context.getString(com.ncautomation.commons.R.string.dismiss), dismissIntent)
